...
<?php $sql = "SELECT products.title,type.typename,products.price,products.id,products.description,products.Vimage1 from products join type on type.id=products.ptype";
